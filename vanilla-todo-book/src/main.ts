...
// state of the app
const todos: string[] = ["Walk the dog", "Water the plants", "Sand the chairs"];

// HTML element references
const addTodoInput: HTMLElement | null = document.getElementById("todo-input");
...
function removeTodo(index) {
  ...
  todosList.childNodes[index].style.textDecoration = "line-through";
}
